...
from XAE.PHASE2.configs import ConfigAttGRUonly
...
cfg = ConfigAttGRUonly()  # get default config parameters
cfg.experiment_name = 'AttGRUonly'
...
for run in range(cfg.num_runs):  # cycle through runs
    ...
    for test_slot in range(10):  # cycle through different test sets
        ...
        loss, acc, conf_mat = test(cfg.device, cfg.class_names, cfg.model_name, cfg.plot_dir,
                                                    ...
                                                    cfg.post_fusion_attention_network, cfg.save_models, merged=False)
