...
def train_model(device, slot_eval, num_epochs, log, face_network, pose_network, attention_network, post_fusion_network,
                dataloader, save, plot_dir, model_name, merged=False):
    """
    This train function only works for attention networks with the structure: 1)face, 1)pose, 3)attention, 4)post_fusion
    """
    ...
    attention_network.model.to(device)
